...
[**exposure.geom**]
`csv`: This will create an exposure CSV file within the exposure folder ([folder strucute](data.qmd)) that contains the [required information](exposure.qmd) per asset.
...
[**vulnerability**]
`file`: This will create an vulnerability curves CSV file within the vulnerability folder ([folder strucute](data.qmd)) that contains the damage curves.
