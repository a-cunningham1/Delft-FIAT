...
Due to its flexibile character, FIAT allows for interoperation with other software such as flood modeling or GIS software and, can be called multiple times, to e.g. assess uncertainty in damage estimates, or run for numerous flood scenarios. 