...
::: {.callout-note}
Flood elevation maps uses the datum as a reference point, whereas flood depth maps use the surface elevation to refer to.
:::

::: {.callout-caution}
Working with elevation maps, the datum must be the same as the one used to obtain the ground elevation in the exposure data.
:::
