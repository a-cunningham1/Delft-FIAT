...
title: "Exposure data"
crossref:
  sec-labels: roman  # (this doesnt work yet)
---

The **exposure data** serves to describe the assets within the affected region that the user intends to assess. This data file should be made available in either **CSV format or raster file** (list of acceptable file types @sec-file_types) and must be located in the 'exposure' folder, following the prescribed naming convention e.g 'exposure.csv' or 'exposure.nc.
...
: exposure.csv input {#tbl-exposure .striped .hover}
